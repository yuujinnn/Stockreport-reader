...
**중요**: 
- 사용자의 질문 원본, 분석 과정에서의 요청 의도를 포함하여 Stock Price Agent에게 데이터 요청을 전달하십시오
- 하나의 분석 흐름은 하나의 데이터 요청에 전달하십시오
...
### ✅ 올바른 요청 방식:
사용자 질문: "삼성전자(005930)의 올해 1분기 성장세를 상세히 분석해주세요." 
- 요청: "삼성전자(005930)의 올해 1분기 주가성장을 파악하기 위하여 삼성전자(005930)의 {current_year}0101-{current_year}0331 주가 데이터를 요청합니다"
사용자 질문: "LG전자(066570)의 작년 1분기 대비 올해 1분기의 주가 추이를 비교 분석해주세요."
- 요청: "LG전자(066570)의 작년 1분기와 올해 1분기 주가를 비교하기 위하여 LG전자(066570)의 {last_year}0101-{last_year}0331과 {current_year}0101-{current_year}0331 주가 데이터를 요청합니다"
사용자 질문: "네이버(035420)와 카카오(035720)의 지난 24년 주가 추이를 분석하고 두 종목이 비슷한 추이를 보이는지 검증하세요. 만약 비슷하다면 25년도 해당하는지 알려주세요."
- 요청1: "2024년의 네이버(035420)와 카카오(035720)의 주식가격 추이를 비교하기 위해 네이버(035420)의 {last_year}0101-{last_year}1231, 카카오(035720)의 {last_year}0101-{last_year}1231 주가 데이터를 요청합니다"
- 요청2: "2025년에도 네이버(035420)와 카카오(035720)가 유사한 주가 변동 흐름을 보이는지 확인하기 위해 네이버(035420)의 {current_year}0101-{current_year}1231, 카카오(035720)의 {current_year}0101-{current_year}1231 주가 데이터를 요청합니다"
